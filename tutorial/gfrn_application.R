...
data_dir <- "~/Downloads/ComBat-seq/ComBat-seq-master/real_data_application"  # path to the signature data (.rds)
source("~/Downloads/ComBat-seq/ComBat-seq-master/real_data_application/gfrn_helpers.R")  # path to gfrn_helpers.R
source("~/Downloads/ComBat-seq/ComBat-seq-master/ComBat_seq.R");
source("~/Downloads/ComBat-seq/ComBat-seq-master/helper_seq.R")
